...
class Lin {
    ...
    initModels(userModel, groupModel, authModel) {
        userModel.init(Object.assign({}, interface_1.UserInterface.attributes), lodash_1.merge({
            sequelize: db_1.db,
            tableName: 'lin_user',
            modelName: 'user'
        }, interface_1.UserInterface.options));
        groupModel.init(Object.assign({}, interface_1.GroupInterface.attributes), lodash_1.merge({
            sequelize: db_1.db,
            tableName: 'lin_group',
            modelName: 'group'
        }, interface_1.GroupInterface.options));
        authModel.init(Object.assign({}, interface_1.AuthInterface.attributes), lodash_1.merge({
            sequelize: db_1.db,
            tableName: 'lin_auth',
            modelName: 'auth'
